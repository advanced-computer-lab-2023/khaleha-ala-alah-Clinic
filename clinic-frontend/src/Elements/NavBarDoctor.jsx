      ...
      <div className={styles.navbarContainer}>
        <div className={styles.navbarLinks}>
          ...
          <div
            ...
            onMouseEnter={() => handleSectionMouseEnter("addSlots")}
            onMouseLeave={() => handleSectionMouseLeave()}
            onClick={(e) =>
              handleSectionClick(e, "AvailableSlotsForm", "/available-slots")
            }
          >
            Manage avaliable slots{" "}
            {hasSubsections("AvailableSlotsForm") && <span>▼</span>}
          </div>
