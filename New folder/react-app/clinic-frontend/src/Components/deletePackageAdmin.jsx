  ...
  return (
    <div>
        ...
        <ul>
          {healthPackages.map((healthPackage) => (
            <li
              ...
              onClick={() => handleHealthPackageClick(healthPackage)}
            >
              {healthPackage.name}
            </li>
          ))}
      ...
      <div>
        ...
        <input
          ...
          onChange={(e) =>
            setFormData({
              ...formData,
              doctorDiscount: parseInt(e.target.value),
            })
          }
        />
        <input
          ...
          onChange={(e) =>
            setFormData({
              ...formData,
              medicalDiscount: parseInt(e.target.value),
            })
          }
        />
        <input
          ...
          onChange={(e) =>
            setFormData({
              ...formData,
              familyDiscount: parseInt(e.target.value),
            })
          }
        />
      </div>
      <div>
        ...
        <button onClick={handleDeleteHealthPackage}>
